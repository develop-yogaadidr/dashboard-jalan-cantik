<div class="row">
    ...
    <div class="col">
        <div class="input-group">
            <input type="text" class="form-control bg-light" placeholder="Cari laporan" aria-label="cari laporan"
                aria-describedby="button-cari-laporan">
    ...
    <div class="col-2">
        <button class="btn btn-outline-primary btn-block" data-toggle="modal" data-target="#exampleModal">Filter
            Laporan</button>
    </div>
