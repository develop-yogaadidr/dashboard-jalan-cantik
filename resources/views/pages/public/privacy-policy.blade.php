    ...
    <div class="container pt-5 pb-5">
        ...
        <div class="text-center mb-lg-4 mb-md-4 mb-sm-4 mb-4">
            ...
            <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
                ...
                created with the help of the <a style="color: red;"
        ...
        <div class="row agile-ser-coloms">
            <div class="col-md-12 ser-list-w3layouts">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        <p><strong>Application</strong> means the software program provided by the Company downloaded by You
                            on any electronic device, named Jalan Cantik</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                            Agreement) refers to DPU Bina Marga Cipta Karya, Jl. Madukoro Blok AA-BB, Semarang.</p>
                    </li>
                    <li>
                ...
                <h4 class="pt-3">Collecting and Using Your Personal Data</h4>
                ...
                <h6 class="pt-2">Information Collected while Using the Application</h6>
                ...
                <h5 class="pt-2">Use of Your Personal Data</h5>
                ...
                <h5 class="pt-2">Retention of Your Personal Data</h5>
                ...
                <h5 class="pt-2">Transfer of Your Personal Data</h5>
                <p>Your information, including Personal Data, is processed at the Company's operating offices and in any
                    ...
                    may be transferred to dpu bmck jateng and maintained on computers located outside of Your state,
                ...
                <h5 class="pt-2">Disclosure of Your Personal Data</h5>
                <h6 class="pt-2">Business Transactions</h6>
                ...
                <h6 class="pt-2">Law enforcemen</h6>
                ...
                <h6 class="pt-2">Other legal requirements</h6>
                ...
                <h5 class="pt-2">Security of Your Personal Data</h5>
                ...
                <h4 class="pt-3">Children's Privacy</h4>
                ...
                <ul class="list-unstyled">
                    <li>By email: <a style="color: red;"
                            href="dpubinmarcipka@jatengprov.go.id">dpubinmarcipka@jatengprov.go.id</a></li>
                </ul>
            </div>
        </div>
    </div>
