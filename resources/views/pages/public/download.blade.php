...
@section('content')
    ...
    <div class="container pt-5">
        ...
        <hr />
        <section class="row mt-5 text-center mb-5 show-on-scroll">
            <h5 class="mb-5">
                Berikut 4 langkah untuk menjalankan aplikasi <strong>Jalan Cantik</strong>
            </h5>
            @foreach ($steps as $key => $step)
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="position-relative show-on-scroll" animate-delay="{{ ($key + 1) * 125 }}">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 align-self-end text-right">
                    <div class="d-inline-flex">
                        <div style="display: block;font-size:16px;align-self:center" class="mr-3">
                            <p class="mb-4">Anda dapat melaporkan situasi kerusakan jalan atau jembatan yang anda lihat
                                melalui aplikasi
